  ...
  const generateRichTextForEmailClients = (data, themeIndex) => {
    ...
    const logoHtml = data.companyName
      ? `<div style="text-align: center; margin-bottom: 25px;">
        <div style="display: inline-block; width: 60px; height: 60px; background-color: ${buttonColor || "#0ea5e9"
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border-radius: 8px; ${backgroundStyle}">
      ${logoHtml}
      <h1 style="font-size: 24px; font-weight: bold; color: ${textColor}; ${data.emailType === "holiday" || data.emailType === "promotion" ? "text-align: center;" : ""
      }">${data.headerText}</h1>
      <h2 style="font-size: 18px; color: #666; margin-top: 10px; ${data.emailType === "holiday" || data.emailType === "promotion" ? "text-align: center;" : ""
      ...
      <div style="text-align: center; margin-top: 25px; margin-bottom: 25px;">
        <a href="${data.ctaUrl
      }" style="display: inline-block; padding: 12px 24px; background-color: ${buttonColor}; color: white; text-decoration: none; border-radius: ${data.emailType === "event" || data.emailType === "promotion" ? "24px" : "4px"
...
<head>
  ...
  <style>
    ...
    .email-${data.emailType} { 
      padding: 30px; 
      background-color: ${data.emailType === "business" || data.emailType === "corporate"
        ? "#f7f7f7"
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="flex flex-col items-center mb-8 text-center">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h1 className="text-3xl font-bold text-slate-800">Title Here</h1>
        </div>
